...
inert primes, theoretically requiring $S_p = 0$ exactly.
...
def main() -> None:
    ...
    if mode != "plot":
        try:
            # Using f-string grouping for better readability (e.g., 100,000)
    ...
    try:
        # Pass parameters to the core pipeline
    ...
    # ── Reports and figures ───────────────────────────────────────────────────
    print("\n[Finalizing] Generating reports and high-resolution figures...")
